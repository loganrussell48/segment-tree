...
void main() {
  ...
  SegmentTree<num> segmentTree2 = SegmentTree.min(arr);
  ...
  print(
      'Min (compareTo method) Segment Tree\n---------------------------------');
  ...
  print(
      'Plus Operator Segment Tree (Strings)\n---------------------------------');
  ...
  print(st5.query(
      1, 2)); // Output: 'banana' - since length is tie, the first one wins
  print(st5.query(0,
      3)); // Output: 'app' - smallest(by length) string is 'app' with 3 letters
  print('\n');
  ...
  print(st6.query(
      1, 2)); // Output: 'banana' - since length is tie, the first one wins
  print(st6.query(0,
      3)); // Output: 'banana' - smallest(by length) string is 'app' with 3 letters
  print('\n');

  print(
      'Alternate Query Syntax using [record]\n---------------------------------');
  print(segmentTree1); //Print the tree
  print(segmentTree1.query(0, 2)); //show the result from using query method
  print(segmentTree1[(0, 2)]); //show the result from alternate syntax
  print('\n');
}
